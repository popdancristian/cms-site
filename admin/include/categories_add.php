...
$id_ordon = $o_db->GetOne('select max(ordon) from category');
$id_ordon++;

echo '<tr><td class="titlu"><a href="index.php?page=categories" class="calea">Gestionare Categorii</a>&nbsp;>&nbsp;Adaugare</td></tr>';
echo'<tr><td><form method="post"  action="submit.php" onsubmit="return validate_form([[\'title\',\'required\',\'Titlu\']]);"><input type="hidden" name="page" value="categories"><input type="hidden" name="action" value="add">';
